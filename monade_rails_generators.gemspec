...
Gem::Specification.new do |spec|
  ...
  spec.homepage      = "https://gitlab.com/monade-srl/monade_rails_generators"
  spec.license       = "MIT"
  spec.required_ruby_version = ">= 2.7.0"

  spec.metadata["homepage_uri"] = spec.homepage
  spec.metadata["source_code_uri"] = spec.homepage
  spec.metadata["changelog_uri"] = "https://gitlab.com/monade-srl/monade_rails_generators/CHANGELOG.md"
